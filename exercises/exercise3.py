...
class Article:
    ...
    #que funcion cumple property aca
    @property
    def precio(self):
        precio_con_iva= self.costo + self.costo * Article.iva
        precio_final =  precio_con_iva -(precio_con_iva * self.descuento)
        return round( precio_final ,2)
    
    @classmethod
    def actualizar_iva(cls,n):
        cls.iva=n
